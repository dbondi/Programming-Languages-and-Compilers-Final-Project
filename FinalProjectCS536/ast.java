...
class FnBodyNode extends ASTnode {
    ...
    public void codeGen(PrintWriter p, String id) {
    	myDeclList.codeGen(p);
    	myStmtList.codeGen(p,id);
    	Codegen.genLabel("_"+id+"_Exit");
    } 
    ...
    public void codeGen(PrintWriter p, String id) {
    	for(StmtNode node:myStmts){
    		if(node instanceof ReturnStmtNode){
        		((ReturnStmtNode)node).codeGen(p,id);
        	}
    		else if(node instanceof AssignStmtNode){
    			node.codeGen(p);
    			Codegen.genPop(Codegen.T0);
    		}
    		else if(node instanceof PostIncStmtNode){
    			node.codeGen(p);
    			Codegen.genPop(Codegen.T0);
    		...
    		else if(node instanceof PostDecStmtNode){
    			node.codeGen(p);
    			Codegen.genPop(Codegen.T0);
    			Codegen.genPop(Codegen.T1);
    		...
    		else if(node instanceof ReadStmtNode){
    			node.codeGen(p);
...
class VarDeclNode extends DeclNode {
    ...
    public void codeGen(PrintWriter p) {
		if(myId.sym().offset==0)
		{
			//Global Value
			myId.sym().setGlobalSym(true);
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen(PrintWriter p) {
		...
		if(myId.name().equals("main")){
			...
			Codegen.generate("addu",Codegen.FP,Codegen.SP,typeList.size()*16+8);
			
			myBody.codeGen(p,myId.name());
			
			Codegen.generateIndexed("lw",Codegen.RA,Codegen.FP,typeList.size()*-4);
			Codegen.generate("move", Codegen.T0, Codegen.FP);
			Codegen.generateIndexed("lw", Codegen.FP, Codegen.FP,(-4*typeList.size())-16);
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p) {
		...
		Codegen.generate("beq", Codegen.T0, Codegen.T1, tempLabel);
		myDeclList.codeGen(p);
		myStmtList.codeGen(p);
		
		Codegen.genLabel(tempLabel);
	}
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen(PrintWriter p) {
    	String labelTemp1=Codegen.nextLabel();
		String labelTemp2=Codegen.nextLabel();
		
		myExp.codeGen(p);
		Codegen.genPop(Codegen.T0);
		Codegen.generate("li", Codegen.T1, 0);
		Codegen.generate("beq", Codegen.T0, Codegen.T1, labelTemp1);
		
		myThenDeclList.codeGen(p);
		myThenStmtList.codeGen(p);
		
		Codegen.generate("j",labelTemp2);
		
		//else
		Codegen.genLabel(labelTemp1);
		
		myElseDeclList.codeGen(p);
		myElseStmtList.codeGen(p);
		
		Codegen.genLabel(labelTemp2);
	}
...
class WhileStmtNode extends StmtNode {
	...
	//false jump
		Codegen.generate("li", Codegen.T1, 0);
		Codegen.generate("beq", Codegen.T0, Codegen.T1, labelTemp2);
		myDeclList.codeGen(p);
		myStmtList.codeGen(p);

		Codegen.generate("j",labelTemp1);
		Codegen.genLabel(labelTemp2);
	}
...
class StringLitNode extends ExpNode {
    ...
    public void codeGen(PrintWriter p) {
		Codegen.generate(".data");
		String labalTemp=Codegen.nextLabel();
		
		Codegen.generateLabeled(labalTemp,".asciiz ","", myStrVal);
		Codegen.generate(".text");
		Codegen.generate("la", Codegen.T0, labalTemp);
		Codegen.genPush(Codegen.T0);
	}
...
class IdNode extends ExpNode {
    ...
    public void setAddr() {
    	if(mySym.getGlobalSym()) {
			Codegen.generate("la", Codegen.T0, "_" + myStrVal);
		} else {
			Codegen.generateIndexed("la", Codegen.T0, Codegen.FP, -1*mySym.offset);
		}
    ...
    public void codeGen() {
		if(mySym.getGlobalSym()){
			...
			Codegen.generateIndexed("lw", Codegen.T0, Codegen.FP, -1*mySym.offset);
			Codegen.genPush(Codegen.T0);
		}
...
class AndNode extends LogicalExpNode {
    ...
    public void codeGen(PrintWriter p) {
		...
		String tempLabel1 = Codegen.nextLabel();
		Codegen.generate("li", Codegen.T1, 1);

		Codegen.generate("bne", Codegen.T0, Codegen.T1, tempLabel1);
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGen(PrintWriter p) {
		...
		Codegen.generate("nor", Codegen.T0, Codegen.T1, tempLabel1);
...
class LessNode extends RelationalExpNode {
    ...
    public void codeGen(PrintWriter p) {
		...
		Codegen.generate("sub", Codegen.T0, Codegen.T0, Codegen.T1);
		Codegen.generate("li", Codegen.T1, 0);
		Codegen.generate("bge", Codegen.T0, Codegen.T1, tempLabel);
...
class GreaterNode extends RelationalExpNode {
	...
	String tempLabel = Codegen.nextLabel();
		...
		Codegen.generate("sub", Codegen.T0, Codegen.T0, Codegen.T1);
		Codegen.generate("li", Codegen.T1, 0);
		Codegen.generate("ble", Codegen.T0, Codegen.T1, tempLabel);
		Codegen.generate("addi", Codegen.T1, 1);
...
class LessEqNode extends RelationalExpNode {
	...
	String tempLabel = Codegen.nextLabel();
		...
		Codegen.generate("sub", Codegen.T0, Codegen.T0, Codegen.T1);
		Codegen.generate("li", Codegen.T1, 0);
		Codegen.generate("bgt", Codegen.T0, Codegen.T1, tempLabel);
		Codegen.generate("addi", Codegen.T1, 1);
...
class GreaterEqNode extends RelationalExpNode {
	...
	String tempLabel = Codegen.nextLabel();
		...
		Codegen.generate("sub", Codegen.T0, Codegen.T0, Codegen.T1);
		Codegen.generate("li", Codegen.T1, 0);
		Codegen.generate("blt", Codegen.T0, Codegen.T1, tempLabel);
		Codegen.generate("addi", Codegen.T1, 1);
